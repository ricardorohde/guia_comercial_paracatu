...
$obj = DAO::getInstance();
$empresas = $obj->listarEmpresasOrd();
        ...
        <div class="container">
            <div class="col-md-12 col-md-offset-0" style="background-color: #FFF">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12">
                            <form role="form" id="formCadPropaganda"> <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" rows="10" id="campoDescricao"></textarea>
                                </div>  
                                <div class="form-group">
                                    <label for="campoLink">
                                        Link :
                                    </label>
                                    <input class="form-control" id="campoLink"  />
                                </div>                             
                                <button class="btn btn-primary" id="btnEnviarPropaganda" type="button">
                                    ENVIAR
                                </button>
