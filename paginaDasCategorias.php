                        ...
                        if ($empresa == null) {
                            ...
                            foreach ($empresa as $var) {
                                if ($obj->verificarPropaganda($var->id_empresa) == 1) {
                                    echo '<a onclick = "encaminharParaEmpresas(' . $var->id_empresa . '.)"><li style="background-color: #f6f6f6; color:#020202; margin-bottom: 3px" class = "list-group-item"><b>✪  ' . strtoupper($var->nome) . ' ✪</b></li></a>';
                                }
                            }
                            foreach ($empresa as $var) {
                                if ($obj->verificarPropaganda($var->id_empresa) == 0) {
